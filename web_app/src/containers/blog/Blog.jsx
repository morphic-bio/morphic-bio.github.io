...
import { blog00, blog01, blog02, blog03, blog04, blog05 } from './imports';
import './blog.css';
  ...
  <section className="morphic__blog section__padding" id="blog">
    ...
    <div className="morphic__blog-container">
      <div className="morphic__blog-container_groupB">
        <Article imgUrl={blog00} date="Nov 26, 2022" text="NIH initiative to systematically investigate and establish function of every human gene"/>
      </div>
    </div>
  </section>
);
